...
public class Principal {
    ...
    public void exibeMenu(){
        ...
        System.out.println("Digite por favor o codigo do modelo para buscar os valroes de avaliação");
        ...
        System.out.println("Todos od veiculos filtados com avalição por ano: ");
